...
const languageStrings = {
  ...
  'es': {
    translation: {
      ...
      LESSON_NOT_FOUND_WITHOUT_LESSON_NUMBER: 'Lo siento, no he podido entender el tema de vocabulario que quieres reproducir.',
      LESSON_NOT_FOUND_REPROMPT: '¿Qué mas puedo hacer por ti?',
      PLAYING_LESSON: 'Reproduciendo el vocabulario del tema %s',
      REPEAT_MESSE: 'Prueba a decir repetir',
      SKILL_NAME: 'palabras en japonés para todos',
      STOP_MESSAGE: '¡Hasta la próxima!',
      TRANSLATIONS: translationsES,
      WELCOME_MESSAGE: 'Bienvenido a %s, o <lang xml:lang="ja-JP">Minna no kotoba</lang>. Puedes preguntar por el vocabulario de los diferentes temas como por ejemplo, tema %s... ¿Que lección quieres escuchar?',
